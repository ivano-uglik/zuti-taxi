      ...
      <div className="bg-taxiYellow min-h-[10vh] flex items-center" id="navbar">
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-around md:mx-auto w-full h-full">
            ...
            <div className="flex md:flex-row md:w-auto justify-center relative z-10 ">
              ...
              >
                <div className="flex justify-around items-center cursor-pointer w-full gap-2">
                  <img src={tr} alt="" className="w-7 h-7" />
          ...
          <div className="hidden w-full md:block md:w-auto md:order-2">
            ...
            >
              <button className="text-xl">Ana Sayfa</button>
            </Link1>
            <Link1
              to="cjenik"
              spy={true}
              ...
              className="pr-8 text-lg"
            >
              <button className="text-xl">Fiyatlandirma</button>
            </Link1>
            <Link1
              to="kontakt"
              spy={true}
              ...
              className="text-lg"
            >
              <button className="text-xl">İletişim</button>
            </Link1>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-[50vh] flex flex-col justify-center items-center w-full h-full ">
        <div className="flex flex-col md:flex-row items-center h-full text-center bg-taxiYellow">
          <div className="flex flex-col justify-center gap-4 md:gap-16 items-center min-h-[50vh] h-full w-full p-2 md:p-8 pb-8">
            <h1 className="font-bold text-2xl xl:text-4xl pt-4 md:pt-auto">
              Vinkovci ve Çevresindeki En İyi Taksi Hizmeti!
            </h1>
            <p className="text-justify px-8 lg:px-32">
              "Žuti Taxi Vinkovci" ("Sarı taksi") web sitesine hoş geldiniz,
              Vinkovci ve çevresinde lider taksi hizmeti.
              <p>
                Profesyonel sürücü ekibimiz, size en uygun fiyatlarla güvenli ve
                konforlu ulaşım sunmak için 7/24 hizmetinizdedir.
              </p>
              <p>
                Modern araç filomuz ve kolay online rezervasyon ile yüksek
                kaliteli ve güvenilir bir hizmet sunuyoruz, ihtiyaçlarınıza
                uygun.
              </p>
            </p>
                  ...
                  <article className="glassmorphism p-8 md:basis-1/3 h-full mb-12 md:mb-auto">
                    <ul>
                      <li className="text-3xl font-bold">
                        Vinkovci içi seyahat
                      </li>
                      <li className="text-2xl">00-24 saat</li>
                      <li className="text-lg">Bir seferde en fazla 4 kişi</li>
                      ...
                      <div className="flex flex-row w-full pb-2 justify-between">
                        <li className="text-md">Kilometre başına</li>
                        <li className="text-md">0,80 &euro; / 6,02kn</li>
                      </div>
                      <div className="flex flex-row w-full pb-2 justify-between">
                        <li className="text-md">Bekleme (saat başı)</li>
                        <li className="text-md">8,00 &euro; / 60,27kn</li>
                      </div>
                      <hr className="border-1 border-black mt-4" />
                      <div className="py-2 ">
                        <li className="font-light opacity-80">
                          Vinkovci'deki yolculuklar, fiyat listesine göre
                          gerçekleştirilir.
                        </li>
                        <li className="font-light opacity-80">
                          Bir taksimetre, müşterinin konumuna varışta
                          başlatılır.
                        </li>
                      </div>
                    </ul>
                  ...
                  <article className="glassmorphism p-8 md:basis-1/3 h-full">
                    <ul>
                      ...
                      <div className="pt-4 font-light">
                        ...
                        <li>
                          <Link to="/tr/fiyatlandirma" onClick={scrollToTop}>
                            <span className="underline underline-offset-4 opacity-100">
                              Fiyat listesine buradan ulaşabilirsiniz.
                            </span>
                          </Link>
                        </li>
                        <li>
                          Lütfen diğer tüm yerler için bizimle iletişim kurun.
                          Lütfen bize bir mesaj yazın, çünkü çağrı
                          operatörlerimiz Türkçe anlamamaktadır.
                        </li>
                      </div>
                    </ul>
                  </article>
              ...
              <article className="bg-taxiBlack backdrop-blur-none rounded-[16px] p-8 md:basis-1/4 mb-12 md:mb-auto h-full">
                ...
                <div className="flex flex-col pt-6 h-full gap-y-8">
                  <h1 className="text-lg">
                    Facebook'ta bizi bulun veya Messenger üzerinden bize mesaj
                    gönderin:
                  </h1>
                  {/* <a
                ...
                <div className="flex flex-col justify-around h-full gap-y-8">
                  <div className="">
                    <h2 className="text-lg">
                      Bizi arayın veya bir SMS mesajı gönderin:
                    </h2>
                  ...
                  <p className="text-xs font-light opacity-80">
                    *Mobil operatörünüze bağlı olarak standart arama ve SMS
          ...
          <div className="flex flex-row justify-around h-full">
            ...
            <div className="bg-taxiYellow text-taxiBlack rounded-lg w-[40%] flex flex-col lg:px-16 xl:px-[6vw] lg:py-8 xl:py-[8vh] gap-8">
              <div className="flex items-center flex-col">
                ...
                <h3 className="text-xl">00-24 saat</h3>
                <h3 className="text-xl">Bir seferde en fazla 4 kişi</h3>
                ...
                <div className="w-full pt-4 xl:px-4">
                  <div className="flex flex-row justify-between">
                    <h3>Kilometre başına</h3>
                    <h3>0,80 &euro; / 6,02kn</h3>
                  </div>
                  <div className="flex flex-row justify-between">
                    <h3>Bekleme (saat başı)</h3>
                    <h3>8,00 &euro; / 60,27kn</h3>
                  </div>
                </div>
                <span className="opacity-50 pt-4">
                  Vinkovci'deki yolculuklar, fiyat listesine göre
                  gerçekleştirilir.Bir taksimetre, müşterinin konumuna varışta
                  başlatılır.
                </span>
              </div>
              <div className="flex items-center flex-col">
                <h1 className="font-bold text-3xl pb-4">Vinkovci dışında</h1>
                <hr className="border-1 border-taxiBlack w-full" />
                ...
                <span className="opacity-50 pt-4">
                  Vinkovci dışındaki yolculuklar sabit bir fiyat listesine göre
                  belirlenir.
                  <Link to="/tr/fiyatlandirma" onClick={scrollToTop}>
                ...
                <span className="opacity-50">
                  Lütfen diğer tüm yerler için bizimle iletişim kurun. Lütfen
                  bize bir mesaj yazın, çünkü çağrı operatörlerimiz Türkçe
                  anlamamaktadır.
                </span>
              </div>
            </div>
        ...
        <div className="overflow-hidden">
          <footer className="text-xs md:text-base flex w-full flex-col bg-gray-900 text-taxiYellow justify-around font-light py-2 md:py-4 lg:px-36">
            ...
            <div className="flex justify-center flex-col text-center items-center py-4 text-xs md:text-base px-2">
              <h1>&#169; 2023 - Žuti Taxi Vinkovci. Tüm hakları saklıdır.</h1>
              <h1>
                Web sitesi Ivano Uglik tarafından yapılmıştır.&nbsp;|&nbsp;
                <a

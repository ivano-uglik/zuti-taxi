        ...
        <article className="glassmorphism p-8 md:basis-1/3 h-full mb-12 md:mb-auto">
          <ul>
            ...
            <div className="relative">
              <li className="text-lg absolute">Vožnja po km</li>
              <li className="text-lg text-end pb-2">0,80 &euro; / 6,02kn</li>
            </div>
            <div className="relative">
              <li className="text-lg absolute">Čekanje po satu</li>
              <li className="text-lg text-end">8,00 &euro; / 60,27kn</li>
            </div>
